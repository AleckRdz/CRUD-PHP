...
$sentencia = $bd->query(
    "SELECT a.idAlumno, a.nombre, a.apellidoPaterno, a.apellidoMaterno, c.matematicas, c.espanol, c.ingles, c.geografia, c.quimica, c.fisica, FORMAT((c.matematicas+c.espanol+c.ingles+c.quimica+c.fisica+c.geografia)/6,2) AS promedio 
    FROM alumnos AS a 
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="text-center"><?php echo $dato->espanol; ?></td>
                                            <td class="text-center"><?php echo $dato->ingles; ?></td>
                                            <td class="text-center"><?php echo $dato->geografia; ?></td>
                                            <td class="text-center"><?php echo $dato->quimica; ?></td>
                                            <td class="text-center"><?php echo $dato->fisica; ?></td>
                                            <td class="text-center"><?php echo $dato->promedio; ?></td>
