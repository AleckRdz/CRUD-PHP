...
$sentencia = $bd->query(
    "SELECT a.idAlumno, a.nombre, a.apellidoPaterno, a.apellidoMaterno, FORMAT((c.matematicas+c.espanol+c.ingles+c.quimica+c.fisica+c.geografia)/6,2) AS promedio 
    FROM alumnos AS a 
...
<!-- script para saltar mensaje de advertencia al visitar el sitio por primera vez usando ngrok -->
<script>
        fetch(url, {
        method: "get",
        headers: new Headers({
